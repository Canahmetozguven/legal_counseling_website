...
const aboutData = {
  mission: 'To provide exceptional legal services with integrity and dedication, ensuring that every client receives personalized attention and effective representation.',
  values: [
  ...
  history: 'Founded in 2020, our firm has grown to become a trusted legal partner for individuals and businesses throughout the region. What began as a small practice with three dedicated attorneys has evolved into a comprehensive legal service provider with expertise across multiple practice areas. Throughout our growth, we have maintained our commitment to personalized service and exceptional results for every client.',
  teamMembers: [
    {
      name: 'John Smith',
