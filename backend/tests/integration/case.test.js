...
describe('Case Routes', () => {
  describe('POST /api/cases', () => {
    it('should create a new case', async () => {
      ...
      expect(response.body.data.case.assignedLawyer).toBe(testUser._id.toString());
  ...
  describe('PATCH /api/cases/:id', () => {
    it('should update case details', async () => {
      ...
      expect(response.body.data.case.resolution).toBe('Case settled out of court');
    });
  ...
  describe('POST /api/cases/:id/timeline', () => {
    it('should add timeline entry', async () => {
      ...
      expect(response.body.data.timeline[0].description).toBe(timelineEntry.description);
    });
  });
});