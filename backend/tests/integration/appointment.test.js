...
describe('Appointment Routes', () => {
  describe('POST /api/appointments', () => {
    it('should create a new appointment', async () => {
      ...
      expect(response.body.data.appointment.client).toBe(testClient._id.toString());
      expect(response.body.data.appointment.type).toBe('consultation');
      expect(new Date(response.body.data.appointment.date)).toEqual(appointmentData.date);
    });
  ...
  describe('GET /api/appointments', () => {
    ...
    it('should filter appointments by date range', async () => {
      ...
      expect(new Date(response.body.data.appointments[0].date).getMonth()).toBe(3); // April
    });
  });
  ...
  describe('PATCH /api/appointments/:id', () => {
    it('should update appointment', async () => {
      ...
      expect(response.body.data.appointment.notes).toBe('Extended consultation needed');
    });
  });
