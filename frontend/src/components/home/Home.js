          ...
          setHomeCards([
            {
              ...
              description:
                'Our team of experienced attorneys provides comprehensive legal counsel across various practice areas.',
            ...
            },
            {
              ...
              description:
                'We prioritize understanding your unique needs and developing tailored legal solutions.',
            ...
            },
            {
              ...
              description:
                'Our successful case history demonstrates our commitment to achieving the best possible outcomes for our clients.',
      ...
      >
        ...
        >
          ...
          <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <Typography sx={{ flexGrow: 1 }}>{card.description}</Typography>
      ...
      <Container>
        <Box sx={{ pt: 8, pb: 6 }}>
          ...
          <Typography variant="h5" align="center" color="text.primary" paragraph>
            Professional legal counsel dedicated to protecting your rights and interests. With years
            of experience, we provide expert guidance across various areas of law.
          </Typography>
